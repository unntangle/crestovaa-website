...
export const metadata = {
	title: {
		default: "Crestovaa - Consultancy Pvt Ltd",
		template: "%s | Crestovaa",
	},
	description: "Crestovaa Consultancy Pvt Ltd - Expert guidance for your career path and placement opportunities.",
	icons: {
		icon: "/images/fav.png",
