...
const Services2 = () => {
	...
	return (
		<section className="tj-service-section service-2 section-top-gap pb-70 mb-70 section-gap-x">
					...
					<div className="col-lg-4">
						<div className="content-wrap">
							<div className="sec-heading style-2">
								...
								<h2 className="sec-title text-white wow fadeInUp" data-wow-delay=".4s">
									Tailored Consultancy & Tech Solutions for
