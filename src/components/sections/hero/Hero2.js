...
const Hero2 = () => {
	...
	const heroSlides = [
		{
			subtitle: "Strategic Placement Partners",
			title: (
				<>
					Expert Job Consultancy & <span>Career Guidance.</span>
				</>
			),
			desc: "Connecting talented professionals with industry-leading opportunities across IT, Non-IT, and BPO sectors.",
		...
		},
		{
			...
			title: (
				<>
					Scalable Web & <span>Software Development.</span>
				</>
			),
			desc: "Building high-performance digital products tailored to your business goals and technological needs.",
			img: "/images/hero/slider-2.webp",
			thumbImg: "/images/hero/slider-thumb-2.webp",
		},
		{
			subtitle: "Result-Driven Excellence",
			title: (
				<>
					Driving Success Through <span>Industry Expertise.</span>
				</>
			),
			desc: "Comprehensive business consultancy and digital marketing strategies for sustainable growth.",
